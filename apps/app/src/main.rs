...
async fn initialize_state(app: tauri::AppHandle) -> api::Result<()> {
    ...
    tracing::info!("Lumina Launcher state successfully initialized.");
    Ok(())
}
...
fn main() {
    ...
    */
    ...
    tracing::info!("Initialized tracing subscriber. Loading Lumina Launcher!");
