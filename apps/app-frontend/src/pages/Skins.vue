...
const messages = defineMessages({
	...
	modrinthPrideSection: {
		...
		defaultMessage: 'Lumina Pride',
	},
	modrinthPrideTooltip: {
		id: 'app.skins.section.modrinth-pride.tooltip',
		defaultMessage:
			'You received these skins for donating to a Lumina Pride fundraiser during Pride Month.',
	},
	modrinthSection: {
		id: 'app.skins.section.modrinth',
		defaultMessage: 'Lumina',
	},
	defaultSkinsSection: {
	...
	excitedRinthbotAlt: {
		...
		defaultMessage: 'Excited Lumina Bot',
	},
	signInTitle: {
	...
	signInDescription: {
		...
		defaultMessage:
			'Please sign into your Minecraft account to use the skin management features of Lumina Launcher.',
	},
	signInButton: {
