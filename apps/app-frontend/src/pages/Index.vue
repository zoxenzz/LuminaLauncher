...
import PartneredServers from '@/components/ui/world/PartneredServers.vue'
import YourServersList from '@/components/ui/world/YourServersList.vue'
...
<template>
	<div class="p-6 flex flex-col gap-2">
		...
		<h1 v-else class="m-0 text-2xl font-extrabold">Welcome to Lumina Launcher!</h1>
		<YourServersList />
		<PartneredServers />
		<RowDisplay
