...
const messages = defineMessages({
	...
	warningBody: {
		...
		defaultMessage: `We couldn't find this file on Lumina Launcher. We strongly recommend only installing files from sources you trust.`,
	},
	body: {
		id: 'unknown-pack-warning-modal.body',
		defaultMessage: `A file is only reviewed if it’s uploaded to Lumina Launcher, regardless of its file format (including .mrpack).`,
	},
	malwareStatement: {
